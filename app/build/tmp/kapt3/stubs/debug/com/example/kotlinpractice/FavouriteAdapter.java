...
public final class FavouriteAdapter extends androidx.recyclerview.widget.RecyclerView.Adapter<com.example.kotlinpractice.FavouriteAdapter.ViewHolder> {
    ...
    @org.jetbrains.annotations.Nullable()
    public final java.util.ArrayList<com.example.kotlinpractice.UserFavouriteModel> getUserlist() {
        return null;
    }
    
    public final void setUserlist(@org.jetbrains.annotations.Nullable()
    java.util.ArrayList<com.example.kotlinpractice.UserFavouriteModel> p0) {
    }
    ...
    @java.lang.Override()
    public com.example.kotlinpractice.FavouriteAdapter.ViewHolder onCreateViewHolder(@org.jetbrains.annotations.NotNull()
    ...
    com.example.kotlinpractice.FavouriteAdapter.ViewHolder holder, int position) {
    }
